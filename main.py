    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if any(x in url for x in ["https://cpvod.testbook.com/", "classplusapp.com/drm/", "media-cdn.classplusapp.com", "media-cdn-alisg.classplusapp.com", "media-cdn-a.classplusapp.com", "tencdn.classplusapp", "videos.classplusapp", "webvideos.classplusapp.com"]):
                ...
                api_url_call = f"https://itsgolu-cp-api.vercel.app/api/proxy?url={url}@ITSGOLU_OFFICIAL&user_id={user_id}"
                keys_string = ""
                mpd = None
                try:
                ...
                #signed_api = f"https://itsgolu-cp-api.vercel.app/api/proxy?url={url}@bots_updatee&user_id={user_id}"
...
async def text_handler(bot: Client, m: Message):
    ...
    try:
            ...
            if "acecwply" in url:
                ...
                url = f"https://itsgolu-cp-api.vercel.app/api/proxy?url={url}@bots_updatee&user_id=7793257011"
                #url = f"https://itsgolu-cp-api.vercel.app/api/proxy?url={url}&token={cptoken}&auth=@scammer_botxz1"
